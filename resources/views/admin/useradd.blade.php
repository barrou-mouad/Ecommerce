            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('admin.adduser') }}">
                        ...
                        <div class="form-group row">
                            <label for="number_phone" class="col-md-4 col-form-label text-md-right">{{ __('Numéro telephone') }}</label>

                            <div class="col-md-6">
                                <input id="number_phone" type="text" class="form-control" name="number_phone" required autocomplete="new-password">
                            </div>
                        </div>
                        <div class="form-group row">
